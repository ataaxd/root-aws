...
# Ganti password root menjadi 'revoerscript'
echo "root:revoerscript" | sudo chpasswd
...
wget -O /etc/ssh/sshd_config https://raw.githubusercontent.com/ataaxd/root-aws/main/sshd_config
